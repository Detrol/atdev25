        ...
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mb-6 p-4 bg-green-50 dark:bg-green-900/30 border-l-4 border-green-500 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-green-800 dark:text-green-200">Admin-läge aktivt</p>
                        <p class="text-sm text-green-700 dark:text-green-300 mt-1">Ingen rate limit • Obegränsade granskningar</p>
                    </div>
                </div>
            </div>
            @endauth
