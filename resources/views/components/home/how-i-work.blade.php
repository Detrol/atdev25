...
<section class="relative py-24 bg-white dark:bg-gray-900 overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-20">
        ...
        <div class="absolute w-96 h-96 bg-purple-300 dark:bg-purple-600 rounded-full blur-3xl -bottom-48 -left-48 animate-pulse" style="animation-delay: 2s;"></div>
    </div>
                ...
                <div x-show="expandedStep === 1"
                    ...
                    <div class="grid md:grid-cols-3 gap-4 pt-4 border-t border-blue-200 dark:border-gray-700">
                        ...
                        <div class="p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl">
                            ...
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Fast Offert</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Transparent prisättning med tydligt scope och leveransdatum.</p>
                        </div>
                    </div>
                </div>
            </div>
