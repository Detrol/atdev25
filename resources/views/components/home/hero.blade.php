    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 py-32 text-center text-white" style="min-height: 600px;">
        <div class="space-y-8">
            <div class="flex flex-col gap-3 justify-center items-center fade-in">
                <div class="inline-flex items-center gap-3 px-6 py-3 bg-white/10 dark:bg-white/5 backdrop-blur-md rounded-full border border-white/20 dark:border-white/10 pulse-glow">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/20 dark:bg-purple-500/10 backdrop-blur-md rounded-full border border-purple-400/30 dark:border-purple-400/20">
            ...
            <div class="inline-block px-6 py-3 bg-white/10 dark:bg-white/5 backdrop-blur-md rounded-full border border-white/20 dark:border-white/10 fade-in-delay-400">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 fade-in-delay-500">
                <a href="#projects"
                   ...
                   class="px-8 py-4 bg-white dark:bg-white/90 text-purple-600 rounded-full font-semibold hover:bg-white/90 dark:hover:bg-white transition-all hover:scale-105 shadow-2xl">Utforska Mina Projekt</a>
                <a href="#contact"
                   onclick="if(window.GA4) GA4.trackHeroCTA('contact')"
                   class="px-8 py-4 bg-white/10 dark:bg-white/5 backdrop-blur-md text-white rounded-full font-semibold hover:bg-white/20 dark:hover:bg-white/10 transition-all border border-white/20 dark:border-white/10">Kontakta Mig</a>
