            ...
            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                @if($estimation->solution_approach)
                    <div class="sm:col-span-2">
                        ...
                        <dd class="mt-2">
                            <div class="rounded-lg bg-gradient-to-br from-green-50 to-emerald-50 p-4 ring-1 ring-green-200">
                                <p class="text-sm text-gray-700 whitespace-pre-wrap leading-relaxed">{{ $estimation->solution_approach }}</p>
                            </div>
                        </dd>
                    </div>
                @endif
