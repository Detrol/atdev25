...
return [
    ...
    */
    ...
    'csp' => [
        ...
        'directives' => [
            'default-src' => ["'self'"],
            'script-src' => ["'self'", "'unsafe-inline'", "'unsafe-eval'", 'https://ajax.googleapis.com', 'https://www.googletagmanager.com', 'https://www.google.com', 'https://www.gstatic.com'],
            'script-src-elem' => ["'self'", "'unsafe-inline'", 'https://ajax.googleapis.com', 'https://www.googletagmanager.com', 'https://www.google.com', 'https://www.gstatic.com'],
            'style-src' => ["'self'", "'unsafe-inline'"],
            'img-src' => ["'self'", 'data:', 'https:', 'blob:'],
            'font-src' => ["'self'", 'data:'],
            'connect-src' => ["'self'", 'blob:', 'https://*.google-analytics.com', 'https://ajax.googleapis.com', 'https://www.google.com', 'https://www.gstatic.com'],
